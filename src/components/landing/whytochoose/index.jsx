        ...
        <div className={`${styles.whyChooseUs} main_section`}>
            <div className="max-w-screen-xl mx-auto">
              ...
              financial decisions.
                            ...
                            <div className={`${styles.whyChooseBoxList} grid grid-cols-1 lg:grid-cols-2`} data-aos="fade-up" data-aos-anchor-placement="bottom" >
                                {data.map((item, index) => (
                                    <div key={index} className={`${styles.whyChooseBox} mb-[30px] wow fadeInUp`} data-wow-delay={`${0.2 * (index + 1)}s`}>
