          ...
          <div className="relative bg-white p-6 rounded-xl w-80 shadow-lg z-10">
            ...
            <form onSubmit={handleSubmit} className="mt-4 space-y-3">
              <select
                ...
                className="w-full border bg-[#E7EBEF] border-gray-300 rounded px-3 py-2 text-sm"
              >
              ...
              <input
                ...
                className="w-full border bg-[#E7EBEF] text-black placeholder-red-600 border-gray-300 rounded px-3 py-2 text-sm"
              />
              <input
                type="password"
                ...
                className="w-full border bg-[#E7EBEF] text-black border-gray-300 placeholder-red-600 rounded px-3 py-2 text-sm"
              />
