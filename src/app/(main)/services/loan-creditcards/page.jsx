...
export const metadata = {
  ...
  description:
    "Start Smart with Loans & Credit Card in Ant invest",
};

const MutualFunds = async () => {
  const services = await getServiceData();
  const sitedata = await getSiteData();
  const faqs = serviceFaqs["loancreditcard"] || [];
        ...
        <div className=" grid md:grid-cols-3 gap-10">
          ...
          <div className="md:col-span-2">
            <div className="rounded-xl overflow-hidden mb-6">
              <Image
                src="/service/loans-credit-cards-02.webp"
            ...
            <h2 className="text-3xl font-bold  mb-4">
              Access Quick Loans & Credit Cards with Ease
            </h2>

            <p className=" mb-4">
              <strong className="text-[--rv-primary] text-lg">W</strong>hether you're growing your business, funding education, or managing personal expenses, {sitedata.websiteName} helps you access the right <strong>loan or credit card</strong> tailored to your needs. Compare top options, check eligibility instantly, and apply online — all in one place.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6 mb-4">
              ...
              <div className="flex items-center gap-2 text-sm font-medium text-[rv-secondary)]">
                <IoMdCheckmarkCircleOutline className="text-2xl text-green-600" />{" "}
                 Instant Eligibility Check & Comparison
              </div>
              <div className="flex items-center gap-2 text-sm font-medium text-[rv-secondary)]">
                <IoMdCheckmarkCircleOutline className="text-2xl text-green-600" />{" "}
                Access Top Credit Card Offers
              </div>
              <div className="flex items-center gap-2 text-sm font-medium text-[rv-secondary)]">
                <IoMdCheckmarkCircleOutline className="text-2xl text-green-600" />{" "}
                Guidance on Best Interest Rates
              </div>
              <div className="flex items-center gap-2 text-sm font-medium text-[rv-secondary)]">
                <IoMdCheckmarkCircleOutline className="text-2xl text-green-600" />{" "}
              ...
              <div className="flex items-center gap-2 text-sm font-medium text-[rv-secondary)]">
                <IoMdCheckmarkCircleOutline className="text-2xl text-green-600" />{" "}
                Secure & Hassle-Free Digital Process
              </div>
            </div>

             <p className=" mb-4">
              We partner with trusted banks and NBFCs to bring you the best financial products — with expert support every step of the way.
            </p>
