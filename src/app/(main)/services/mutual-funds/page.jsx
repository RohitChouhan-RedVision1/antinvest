...
const MutualFunds = async () => {
  ...
  <h3 className="text-xl font-semibold text-[--rv-primary] mb-4">Our Service</h3>
...
>
  ...
  <p className=" mb-4">
    <strong className="text-[--rv-primary] text-lg">M</strong>utual Funds offer a powerful way to grow your wealth through professional fund management, diversified portfolios, and risk-balanced strategies. Whether you're a first-time investor or a seasoned planner, mutual funds provide tailored options for all.
  </p>

  <p className=" mb-4">
    With access to equity, debt, hybrid, and tax-saving schemes, mutual funds are designed to meet varied financial goals — from short-term returns to long-term retirement planning. Start your journey today with trusted AMC partners and expert advisors.
  </p>
