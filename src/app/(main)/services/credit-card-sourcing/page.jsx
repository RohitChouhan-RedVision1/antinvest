          ...
          <div className="md:col-span-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6 mb-4">
              <div className="flex items-center gap-2 text-sm font-medium text-[var(--rv-secondary)]">
                <IoMdCheckmarkCircleOutline className="text-2xl text-green-600"/> Access to Top Banks & Credit Cards
              </div>
              <div className="flex items-center gap-2 text-sm font-medium text-[var(--rv-secondary)]">
                <IoMdCheckmarkCircleOutline className="text-2xl text-green-600"/> Customized Card Recommendations
              </div>
              <div className="flex items-center gap-2 text-sm font-medium text-[var(--rv-secondary)]">
                <IoMdCheckmarkCircleOutline className="text-2xl text-green-600"/> Assistance with Application & Documentation
              </div>
              <div className="flex items-center gap-2 text-sm font-medium text-[var(--rv-secondary)]">
                <IoMdCheckmarkCircleOutline className="text-2xl text-green-600"/> Support for First-Time Cardholders
              </div>
              <div className="flex items-center gap-2 text-sm font-medium text-[var(--rv-secondary)]">
                <IoMdCheckmarkCircleOutline className="text-2xl text-green-600"/> Options for Cashback, Rewards & Travel
              </div>
              <div className="flex items-center gap-2 text-sm font-medium text-[var(--rv-secondary)]">
                <IoMdCheckmarkCircleOutline className="text-2xl text-green-600"/> Fast & Transparent Approval Process
              </div>
            </div>
